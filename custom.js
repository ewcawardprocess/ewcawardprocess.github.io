...
//            var requiredStar = '<span class="required_field">*</span>';
    ...
    $(".mobileTelephone input").change(function() {
        ...
        $(this).val("");
        $(this).append('<small class="form-text unmatch-text animated shake" style="color: rgb(220, 53, 69); display: inline-block;" Email address entered does not match. Check again.</small>');
        }
    });
